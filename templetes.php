...
<body>
    ...
    <div class="container ">
        <h2 class="my-4 text-center"><em> Select Your Resume Template</em></h2>
        ...
        echo '  <div class="display-templates card mb-3  bg-dark" "
         ...
         <div class="row g-0">
             ...
             <div class=" col-md-8">
                 <div class="card-body">
                     ...
                     <div class="btn1 ">
                         <a href="form.php?tid='.$tempid.'" class="btn btn-success my-1">Create</a>

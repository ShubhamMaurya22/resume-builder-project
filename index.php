...
<body>
    ...
    <div class="signupForm">
        <div class="firstHalf" style="width: 65%;">
            <h1 class="headline"> Automatic Resume Builder</h1>
            <h3 class="bigText"></h3>
            <div class="main-item">
                <div class="item">
                ...
                <div class="item">
                    ...
                    <div class="iteminfo">
                        <p>Build Your Resume In Few Clicks.</p>
                    </div>
                </div>
                <div class="item">
                ...
                <div class="item">
                    <a href="viewTemplate.php">
                        <button class="Btn-main">OUR TEMPLATE</button>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="wrapper  " data-aos="fade-up">
                ...
                <div class="form-container ">
                    ...
                    <div class="form-inner">
                        <form action="partials/handleLogin.php" method="post" class="login">
                            <div class="field">
                            ...
                            <div class="pass-link">
                                <a href="partials/recover_pws.php">Forgot password?</a>
                            </div>
                            <div class="field btn">
    ...
    function validate() {
        ...
        if (pass.value.length > 6) { //match if function which match regular expresion 
